...
<br id="idx00">
## Download <https://sp.vlsm.org/WEEK/WEEK09.tar.bz2.asc>
```
mkdir -pv $HOME/mywork/
cd $HOME/mywork/
wget -c https://sp.vlsm.org/WEEK/WEEK09.tar.bz2.asc
ls -al

```

<br id="idx01">
## Decrypt file WEEK09.tar.bz2.asc
