...
* E.g., see also <https://github.com/cbkadal/os222/>.

<br id="idx01"><br>
## Create a new Repository (os222)
  * Repository name, e.g:
    * "os222" for year 2022-2 (odd semester 2022/2023),
    * "os231" for year 2023-1 (even semester 2022/2023),
    * "os232" for year 2023-2 (odd semester 2023/2024),
    * "os241" for year 2024-1 (even semester 2023/2024),
    * "os242" for year 2024-2 (odd semester 2023/2024),
    * etc.
    * Note: For "os" use lowercase. Do not use uppercase!
  * **Description**: (e.g.) Operating Systems 2022-2 (Odd Semester 22/23).
